...
class TestConfiguration implements EnviromentConfiguration {
    private static instance : TestConfiguration = undefined;
    //singleton
    static getInstance() : TestConfiguration {
        if (!this.instance) this.instance = new TestConfiguration();
