...
class SecureConfiguration implements EnviromentConfiguration {
    private static instance : SecureConfiguration = undefined;
    //singleton
    static getInstance() : SecureConfiguration {
        if (!this.instance) this.instance = new SecureConfiguration();
